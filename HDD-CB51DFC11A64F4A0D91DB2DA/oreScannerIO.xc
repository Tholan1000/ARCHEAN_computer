...
const $oreScannerAlias = "oreScanner"

var $maxDistanceOfScan = 2000
var $minDistanceOfScan = 1000
var $resolution = 5
...
function @storeBestOreResults($ore : text)
	$distanceOfBestOreForCurrentScan = 0
	$bestOreConcentrationForCurrentScan = 0
	var $numChannels = (($maxDistanceOfScan - $minDistanceOfScan) / $resolution) + 1
