...
function @drawButton($topLeftX : number, $topLeftY : number, $buttonLabel:text, $buttonWidth:number, $isSelected:number) : number
	...
	var $retVal =  $screen.button_rect($topLeftX, $topLeftY - 1, $bottomRightX, $bottomRightY + 1, blue, $buttonColor)
...
function @incrementByHandler()
	...
	if (@drawButton($startButtonX, $topLeftY, "1", $buttonWidth, $incrementBy == 1))
		$incrementBy = 1
	$startButtonX = $startButtonX + $buttonWidth + 2
	if (@drawButton($startButtonX, $topLeftY, "10", $buttonWidth, $incrementBy == 10))
		$incrementBy = 10
	$startButtonX = $startButtonX + $buttonWidth + 2
	if (@drawButton($startButtonX, $topLeftY, "100", $buttonWidth, $incrementBy == 100))
		$incrementBy = 100
	$startButtonX = $startButtonX + $buttonWidth + 2
	if (@drawButton($startButtonX, $topLeftY, "1000", $buttonWidth, $incrementBy == 1000))
		$incrementBy = 1000
